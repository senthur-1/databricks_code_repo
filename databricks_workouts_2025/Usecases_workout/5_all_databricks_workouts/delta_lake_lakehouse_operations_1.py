...
# MAGIC %sql
# MAGIC SELECT count(1) FROM drugstbl_merge TIMESTAMP AS OF '2026-02-23 09:07:17.';
...
# MAGIC %sql
# MAGIC select count(1) from logistics.schema.silver_staff TIMESTAMP AS OF '2026-02-18 10:22:32.';
...
# MAGIC %sql
# MAGIC describe history lakehousecat.deltadb.acid_demo_txn

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from lakehousecat.deltadb.acid_demo_txn;
